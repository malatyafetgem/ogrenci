...
import { tumOgrencileriGetir, veriCacheleriniTemizle } from "./students.js?v=20260604-80";
import { db } from "./firebase-config.js?v=20260604-80";
import {
  collection, getDocs, doc, writeBatch, query, where
} from "./firebase-imports.js?v=20260604-80";
import { toast, onayIste, sinifParcala, compareSinif, escapeHtml, escapeAttr, bugun } from "./utils.js?v=20260604-80";
