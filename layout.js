 ...
 */
import { APP_VERSION, APP_UPDATED_AT } from "./version.js?v=20260529-28";
import { okulAyarlariGetir, okulDonemiEtiketi } from "./school-settings.js?v=20260529-28";
...
function yukleTopbar() {
  ...
  document.getElementById("cikis-btn")?.addEventListener("click", async (e) => {
    e.preventDefault();
    const { logout } = await import("./auth.js?v=20260529-28");
    logout();
  });
}
